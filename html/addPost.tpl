...
<div style="width: 20%; float: left;">
	<span style="font-size: 24px; font-weight: bold; padding-left: 20px;">Treść odpowiedzi:</span>
</div>
<div style="width: 80%; float: left;">
	<textarea style="width: 90%; height: 200px; border-radius: 9px; padding-top: 4px; padding-bottom: 4px; padding-left: 0.5%;" placeholder="Treść odpowiedzi..." name="content"></textarea>
</div>
